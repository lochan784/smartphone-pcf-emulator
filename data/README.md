...
## catalog_devices.csv
- **Source**: Kaggle dataset "Smartphone Specifications and Prices" (link: [ (https://www.kaggle.com/datasets/devgondaliya007/smartphone-specifications-dataset) ]). Please replace with the actual Kaggle URL or citation.
